...
function sideNav(handler) {
  ...
  sideNav.appendChild(loadingOverlay);

  let loadingImage = document.createElement("img");
  loadingImage.src =
    "drive-download-20240418T164448Z-001/Blocks-Loader-200px.svg"; // Replace "loading.png" with the path to your loading image
...
function buy(handler) {
  ...
  let loadingImage = document.createElement("img");
  loadingImage.src = "drive-download-20240418T164448Z-001/Spinner.png"; // Replace "loading.png" with the path to your loading image
  loadingImage.classList.add("loading-image");
  loadingOverlay.appendChild(loadingImage);
  sideNav(!handler);
...
function QtyBtn(qty = 1) {
  ...
  return `
<div>
  <button class='btn-qty' onclick="qtyChange(this,'sub')"><img src="drive-download-20240418T164448Z-001/arrow.png" alt="up" class='fas fa-chevron-left'></img></button>
  <p class='qty'>${qty}</p>
  <button class='btn-qty' onclick="qtyChange(this,'add')"><img src="drive-download-20240418T164448Z-001/arrow_up.png" alt="up"class='fas fa-chevron-right'></img></button>
</div>`;
}
//}
...
function Banner() {
  ...
  <div class='banner'>
    <nav class="navbar">
        <div onclick="toggleMenu()" class="hamburger-menu">
            <img src="drive-download-20240418T164448Z-001/hamburger.png" alt="Cart" style="width: 2rem;">
        </div>
  </nav>
    ...
    <div id="menu" class="menu">
        <ul>
          <li class="menu-item">
              <img
                src="drive-download-20240418T164448Z-001/home.png"
                alt="Home"
                style="width: 1rem"
              />
              Home
  ...
  <div class='nav'>
      <button onclick='sideNav(1)'><img src="drive-download-20240418T164448Z-001/cart.png" alt="Cart" class='fas fa-shopping-cart' style="width: 2rem;"></button>
...
<div class='side-nav'>
  ...
  <div class='final'>
    ...
    <div class='action'>
      <button onclick='buy(1)' class='btn buy'>Purchase <img src="drive-download-20240418T164448Z-001/payments.png" alt="Cart" height="40px" class='fas fa-credit-card' style='color:#6665dd;'></button>
...
<hr>
  ...
  <div>
    ...
    <span class='pay'>₹ ${toPay}</span>
</div>
<div>Mode of payment:</div>
      <div class="payment-option">
        <input type="radio" id="cash" name="payment_method" value="cash" checked>
        <label for="cash"><img src="drive-download-20240418T164448Z-001/cash_logo.png" alt="Cash" class="payment-logo" height="53px"></label><br>
        <span>Cash</span>
      </div>
      <div class="payment-option">
        <input type="radio" id="upi" name="payment_method" value="upi">
        <label for="upi"><img src="drive-download-20240418T164448Z-001/payment-gateway.png" alt="UPI" class="payment-logo" height="63px"></label><br>
        <span>UPI</span>
      </div>
      <div class="payment-option">
        <input type="radio" id="card" name="payment_method" value="card">
        <label for="card"><img src="drive-download-20240418T164448Z-001/credit-card.png" alt="Card" class="payment-logo"></label><br>
        <span>Card</span>
      </div>
  </div>
  <div class='order'>
